...
import { deleteInventoryItem, updateInventoryItem } from '@/lib/actions/inventory.actions';
import type { Inventory, Item } from '@/lib/db/schema';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function InventoryItemActions({ inventoryItem, items }: { inventoryItem: Inventory & { item: Item }, items: Item[] }) {
  const [purchaseDate, setPurchaseDate] = useState<Date | undefined>(inventoryItem.purchaseDate || undefined);
  const [expiryDate, setExpiryDate] = useState<Date | undefined>(inventoryItem.expiryDate || undefined);
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      storage: inventoryItem.storage || undefined,
      purchaseDate: inventoryItem.purchaseDate || undefined,
      expiryDate: inventoryItem.expiryDate || undefined,
      costTotal: parseFloat(inventoryItem.costTotal || '0'),
          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Select name="itemId" defaultValue={inventoryItem.itemId} onValueChange={(value) => form.setValue('itemId', value)}>
      ...
      <AlertDialog>
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <form action={deleteInventoryItem.bind(null, inventoryItem.id)}>
